...
const CardProducto = ({ producto }) => {
    ...
    return (
        <div className="relative flex flex-col items-center w-80 max-w-sm bg-black/20 shadow-md shadow-black/40 bg-clip-border text-gray-700 rounded-xl flex-shrink-0">
